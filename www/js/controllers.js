...
.controller('AppCtrl', function ($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera,  /* Assignment 4 */ $cordovaImagePicker) {
    ...
    $ionicPlatform.ready(function () {
        ...
        $scope.pickFromGallery = function () {
            $cordovaImagePicker.getPictures(optionsImagePick)
        ...
        .controller('DishDetailController', ['$scope', 'dish', '$stateParams', 'menuFactory', 'baseURL', '$ionicListDelegate', '$ionicPopover', '$ionicModal', 'favoriteFactory', '$timeout', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast',
                                    function ($scope, dish, $stateParams, menuFactory, baseURL, $ionicListDelegate, $ionicPopover, $ionicModal, favoriteFactory, $timeout, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
            $scope.baseURL = baseURL;
            $scope.dish = dish;
            ...
            $scope.openFavComment = function (e) {
